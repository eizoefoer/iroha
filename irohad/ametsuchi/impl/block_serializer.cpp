...
namespace iroha {
  namespace ametsuchi {
    ...
    nonstd::optional<model::Transaction> BlockSerializer::deserialize(const std::string json_tx) {
      Document doc;
    ...
    nonstd::optional<model::Transaction> BlockSerializer::deserialize(GenericValue<rapidjson::UTF8<char>>::Object &json_tx) {
